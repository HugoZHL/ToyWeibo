...
def get_all_posts_from_userid(userID):
    weibo1 = Weibo(1, 3, 'test1', '今天天气真好', '2020年1月1日13:45', 1, 2, 3, '#天气#', [], '', '15', [Reply(15, 3, 'test2', 'good', '2020年1月1日13:46', False, '9')])
    weibo2 = Weibo(2, 4, '@test3', '今天天气真差', '2020年1月1日13:47', 5, 6, 7, '#天气#', [(1, 'test2','#感想#', '不错'), (1, '@test3','#感想#', '不错'), (1, '@test4','#感想#', '不错')], 'test2：#感想# 不错 // @test3：#感想# 不错 // @test4：#感想# 不错 // ', '16', [
        Reply(16, 4, 'test4', 'bad', '2020年1月1日13:48', True, '10'),
        Reply(17, 5, 'test5', 'not bad', '2020年1月1日13:49', False, '11'),
        ])
    posts = [weibo1, weibo2]
    return posts
