...
def get_all_posts_from_userid(userID):
    ...
    weibo2 = Weibo(2, 4, '@test3', '今天天气真差', '2020年1月1日13:47', 5, 6, 7, '#天气#', [(1, 'test2', '不错'), (1, '@test3', '不错'), (1, '@test4', '不错')], 'test2：不错 // @test3：不错 // @test4：不错 // ', [
        Reply('test4', 'bad', '2020年1月1日13:48', 8, 'test3'),
        Reply('test5', 'not bad', '2020年1月1日13:49', 9, 'test5'),
        ])
    posts = [weibo1, weibo2]
...
def get_all_host_posts(userID):
    ...
    weibo2 = Weibo(2, 6, '@test3', '今天天气真差', '2020年1月1日13:47', 5, 6, 7, '#天气#', [(1, 'test2', '不错'), (1, '@test3', '不错'), (1, '@test4', '不错')], 'test2：不错 // @test3：不错 // @test4：不错 // ', [
        Reply('test4', 'bad', '2020年1月1日13:48', 8, 'test3'),
        Reply('test5', 'not bad', '2020年1月1日13:49', 9, 'test5'),
        ])
    posts = [weibo1, weibo2]
